...
const Location = () => {
  return (
    <div className="flex flex-col  items-center justify-center bg-gray-100 ">
      <div className="px-[5%] min-h-[70vh] md:min-h-[50vh] outfit !p-[5%] bg-gray-950 text-white flex flex-col items-center gap-6 w-full">
        ...
        <div className="flex flex-col gap-[2rem]">
          ...
          <div className="grid md:grid-cols-2">
            <div className="md:border-r md:border-white !p-2 !px-5 flex flex-col gap-2">
              ...
              <div className=" hidden md:flex text-xs md:text-md items-center !my-4 gap-3">
                <MapPin className="text-white w-5 h-5" />
                43 Enterprise Road, PO Box 01100, Nairobi, <br />
                Nairobi , Kenya
              </div>
              <p className="text-zinc-400 font-light w-fit !mt-4 !p-1 border-b">
                Opening times:
              </p>
              <div>
